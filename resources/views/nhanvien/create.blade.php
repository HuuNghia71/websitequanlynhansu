<div id="app-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3><i class="bi bi-plus-circle"></i> Thêm nhân viên mới</h3>
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form id="formNhanVien" onsubmit="submitForm(event)">
                @csrf
    ...
    try {
        ...
        if (response.ok) {
            ...
            alertError.innerHTML = `<div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="bi bi-check-circle"></i> ${responseData.message || 'Thêm nhân viên thành công!'}
        ...
        btnSubmit.innerHTML = '<i class="bi bi-check-circle"></i> Lưu';
    }
}
</script>
